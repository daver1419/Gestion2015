...
alter table THE_ULTIMATES.Transaccion drop constraint FK_transac_transf_id;
...
drop procedure THE_ULTIMATES.SP_CargarTransacciones;
drop procedure THE_ULTIMATES.SP_CargarItemsFactura;
